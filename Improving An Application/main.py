...
def load_data(filename):
    ...
    data_list.append(second_list.pop(0))
    data_list.append(second_list)
    num_processors_load = int(data_list[0])
    processes_load = data_list[1]
    return num_processors_load, processes_load
...
if __name__ == "__main__":
    num_processors, processes = load_data("Processes_input1.txt")
    #sys.argv[1]
